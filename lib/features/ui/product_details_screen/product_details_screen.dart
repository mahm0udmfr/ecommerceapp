          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Size', style: AppStyles.medium18Primary),
                  SizedBox(
                    height: 8.h,
                  ),
                  SizedBox(
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Color', style: AppStyles.medium18Primary),
                  SizedBox(
                    height: 8.h,
                  ),
                  SizedBox(
                ...
                children: [
                  Column(
                    children: [
                      Text(
                        'Total price',
                        style: AppStyles.medium18Primary.copyWith(
                            color: AppColors.primaryColor.withOpacity(0.6)),
                      ),
                      SizedBox(
                        height: 12.h,
                      ),
                      Text('EGP ${args.price}', style: AppStyles.medium18Primary)
                    ],
                  ),
                  SizedBox(
                    width: 33.w,
